...
const extraProperties: INodeProperties[] = [
  ...
  // Dynamic Main ID field based on folder type
  {
    ...
    description: '={{ $parameter["folderType"] == 1 ? "Enter a Request ID" : $parameter["folderType"] == 2 ? "Enter a Quote ID" : $parameter["folderType"] == 3 ? "Enter an Order ID" : $parameter["folderType"] == 4 ? "Enter a Job ID" : $parameter["folderType"] == 5 ? "Enter a Job ID" : $parameter["folderType"] == 6 ? "Enter a Customer ID" : $parameter["folderType"] == 7 ? "Enter a Resource ID" : $parameter["folderType"] == 8 ? "Enter a Project ID" : $parameter["folderType"] == 9 ? "Enter an Invoice ID" : $parameter["folderType"] == 10 ? "Enter a Credit Note ID" : $parameter["folderType"] == 11 ? "Enter a Payable ID" : $parameter["folderType"] == 12 ? "Enter an Item ID" : $parameter["folderType"] == 13 ? "Enter a User ID" : $parameter["folderType"] == 14 ? "Enter a Workflow ID" : $parameter["folderType"] == 15 ? "Enter a Quality Manager ID" : $parameter["folderType"] == 16 ? "Enter an Admin ID" : $parameter["folderType"] == 17 ? "Enter a Custom Fields ID" : $parameter["folderType"] == 18 ? "Enter a Document ID" : $parameter["folderType"] == 19 ? "Enter an Outgoing Invoice ID" : $parameter["folderType"] == 20 ? "Enter a Job Round ID" : $parameter["folderType"] == 21 ? "Enter a Customer Address ID" : $parameter["folderType"] == 22 ? "Enter a Customer Contact ID" : $parameter["folderType"] == 23 ? "Enter a Job ID" : $parameter["folderType"] == 24 ? "Enter a Resource Address ID" : $parameter["folderType"] == 25 ? "Enter a Resource Contact ID" : $parameter["folderType"] == 26 ? "Enter a Job ID" : "Enter the appropriate ID for the selected folder type" }}',
    displayOptions: { show: { resource: [RESOURCE], operation: ['getFileList', 'download_Document'] } },
  },
