...
const PARAM_ORDER: Record<string, string[]> = {
    ...
    // objects / simple getters
    getCustomerObject: ['customerID'], // keep if you want it in Misc too; remove if strictly Core-only
...
const RETURN_TYPE: Record<string, R> = {
    ...
    getCustomerObject: 'Customer', // drop if Core-only
    getAccount: 'Account',
