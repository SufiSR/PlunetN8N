...
const OPERATION_REGISTRY: ServiceOperationRegistry = {
    ...
    setRequestID: {
        soapAction: 'setRequestID',
        endpoint: ENDPOINT,
        uiName: 'Set Request ID',
        subtitleName: 'set request id: order fields',
        titleName: 'Set Request ID',
        resource: RESOURCE,
        resourceDisplayName: RESOURCE_DISPLAY_NAME,
        description: 'Set the request ID for an order',
        returnType: 'Void',
        paramOrder: ['orderID', 'requestID'],
        active: true,
    },
    setCreationDate: {
        soapAction: 'setCreationDate',
        endpoint: ENDPOINT,
        uiName: 'Set Creation Date',
        subtitleName: 'set creation date: order fields',
        titleName: 'Set Creation Date',
        resource: RESOURCE,
        resourceDisplayName: RESOURCE_DISPLAY_NAME,
        description: 'Set the creation date for an order',
        returnType: 'Void',
        paramOrder: ['orderID', 'creationDate'],
        active: true,
    },
    setEN15038Requested: {
        soapAction: 'setEN15038Requested',
        endpoint: ENDPOINT,
        uiName: 'Set EN15038 Requested',
        subtitleName: 'set en15038 requested: order fields',
        titleName: 'Set EN15038 Requested',
        resource: RESOURCE,
        resourceDisplayName: RESOURCE_DISPLAY_NAME,
    ...
    setExternalID: {
        soapAction: 'setExternalID',
        endpoint: ENDPOINT,
        uiName: 'Set External ID',
        subtitleName: 'set external id: order fields',
        titleName: 'Set External ID',
        resource: RESOURCE,
        resourceDisplayName: RESOURCE_DISPLAY_NAME,
        description: 'Set the external ID for an order',
        returnType: 'Void',
        paramOrder: ['orderID', 'externalID'],
        active: true,
    },
    setMasterProjectID: {
        soapAction: 'setMasterProjectID',
        endpoint: ENDPOINT,
        uiName: 'Set Master Project ID',
        subtitleName: 'set master project id: order fields',
        titleName: 'Set Master Project ID',
        resource: RESOURCE,
        resourceDisplayName: RESOURCE_DISPLAY_NAME,
        description: 'Set the master project ID for an order',
        returnType: 'Void',
        paramOrder: ['orderID', 'masterProjectID'],
        active: true,
    },
    setProjectCategory: {
        soapAction: 'setProjectCategory',
        endpoint: ENDPOINT,
        uiName: 'Set Project Category',
        subtitleName: 'set project category: order fields',
        titleName: 'Set Project Category',
        resource: RESOURCE,
        resourceDisplayName: RESOURCE_DISPLAY_NAME,
    ...
    setProjectStatus: {
        ...
        subtitleName: 'set project status: order fields',
        titleName: 'Set Project Status',
        resource: RESOURCE,
        resourceDisplayName: RESOURCE_DISPLAY_NAME,
