import {
  ...
  const OPERATION_REGISTRY: ServiceOperationRegistry = {
    ...
    getTaxType: {
      soapAction: 'getTaxType',
      endpoint: ENDPOINT,
      uiName: 'Get Tax Type',
      subtitleName: 'get tax type: item',
      titleName: 'Get Tax Type',
      resource: RESOURCE,
      resourceDisplayName: RESOURCE_DISPLAY_NAME,
      description: 'Get tax type for an item',
      returnType: 'Integer',
      paramOrder: ['itemID', 'projectType'],
      active: true,
    },
    setTaxType: {
      soapAction: 'setTaxType',
      endpoint: ENDPOINT,
      uiName: 'Update Tax Type',
      subtitleName: 'update tax type: item',
      titleName: 'Update Tax Type',
      resource: RESOURCE,
      resourceDisplayName: RESOURCE_DISPLAY_NAME,
      description: 'Update tax type for an item',
      returnType: 'Void',
      paramOrder: ['itemID', 'projectType', 'taxType'],
      active: true,
    },
  };
